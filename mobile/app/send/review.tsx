...
export default function ReviewStep() {
  ...
  return (
    <WizardScreen title="Review your shipment" onContinue={book} continueLabel={booking ? 'Creating shipment…' : 'Confirm and create shipment'} continueDisabled={!confirmed || booking || missingHsCode} continueLoading={booking} error={error}>
